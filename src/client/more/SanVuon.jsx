...
function SanVuonNgoaiTroiMore(props) {
  const [sort, setSort] = useState("default");
  const [products, setProducts] = useState([]);
  const [filter, setFilter] = useState([]);
  const [productFilter, setProductFilter] = useState([]);
  var category = "sanvuonngoaitroi";
  ...
  return (
    <div className="more-sanvuonngoaitroi">
      ...
      <div className="row-sum">
        <div>
          ...
          <div className="row-button">
            ...
            <button value="Đồng" onClick={(e) => setFilter(e.target.value)}>
              Đồng
            </button>
          </div>
        </div>
...
export default SanVuonNgoaiTroiMore;
